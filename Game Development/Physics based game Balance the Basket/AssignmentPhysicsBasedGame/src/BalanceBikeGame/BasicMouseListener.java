...
public class BasicMouseListener extends MouseInputAdapter {
	...
	public void mouseDragged(MouseEvent e) {
		...
		if (mouseJoint!=null) {
		...
		} else if (CONSTANTS.ALLOW_MOUSE_POINTER_TO_DRAG_BODIES_ON_SCREEN) {
			...
			if (bodyUnderMousePointer!=null) {
				...
				mj.dampingRatio = 0;
				MouseJoint mouseJoint = (MouseJoint) CONSTANTS.world.createJoint(mj);
	...
	public static void linkMouseDragEventToANewMouseJoint(MouseJoint mj) {
		if (mouseJoint!=null) {
			...
			CONSTANTS.world.destroyJoint(mouseJoint);
            mouseJoint = null;
		}
		mouseJoint=mj;
	}
	...
	public static Body findBodyAtWorldCoords(Vec2 worldCoords) {
		...
		CONSTANTS.world.queryAABB(callback, queryAABB);
